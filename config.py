...
#   Key([mod], "space", lazy.layout.next(), desc="Move window focus to other window"),
    ...
    #App Configs
    Key([mod], "c", lazy.spawn(browser), desc="Launch Primary Web Browser"),
    Key([mod, "shift"], "c", lazy.spawn(browser2), desc="Launch Secondary Web Browser"),
...
layouts = [
   # layout.(border_focus_stack=["#d75f5f", "#8f3d3d"], border_width=4),
